package com.spxts.tdms.agent.dto;
...
public class DBFDTO {
	...
	private HashMap<String, String> deletedRecord;
	...
	public HashMap<String, String> getDeletedRecord() {
		return deletedRecord;
	}
	public void setDeletedRecord(HashMap<String, String> deletedRecord) {
